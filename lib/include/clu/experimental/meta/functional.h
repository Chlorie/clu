...
namespace clu::meta
{
    ...
    struct bind_front
    {
        ...
        struct call
        {
            using type = typename Func<Ts..., Us...>::type;
        };
    };
    ...
    struct bind_back
    {
        ...
        struct call
        {
            using type = typename Func<Us..., Ts...>::type;
        };
    };
    // @formatter:on
    ...
    template <typename T, typename U>
        requires(is_integral_constant_v<T> && is_integral_constant_v<U>)
    ...
    template <typename T>
        requires is_integral_constant_v<T>
    struct negate<T> : integral_constant<-T::value>
    {
    };
