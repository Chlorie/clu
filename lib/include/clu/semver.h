...
namespace clu
{
    ...
    private:
        ...
        static std::vector<size_t> validate_and_separate(const std::string_view str, const bool no_leading_zero = false)
        {
    ...
    public:
        ...
        semver(const u32 major, const u32 minor, const u32 patch, std::string prerelease = "", std::string build = ""):
