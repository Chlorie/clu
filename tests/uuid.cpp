...
TEST_CASE("uuid construction", "[uuid]")
{
    ...
    REQUIRE(clu::uuid::generate_name_based_md5(clu::uuid(), "").version() == clu::uuid::version_type::name_based_md5);
...
TEST_CASE("uuid string conversion", "[uuid]")
{
    ...
    SECTION("round trip")
    {
        REQUIRE("b2c06c36-f2f6-52f0-a0df-a6a2572bef96"_uuid.to_string() == "b2c06c36-f2f6-52f0-a0df-a6a2572bef96");
    }
}
