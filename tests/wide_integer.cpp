...
TEST_CASE("uint128 literals", "[wide_integer]")
{
    ...
    REQUIRE( // Really large number
        0xfedc'ba98'7654'3210'0123'4567'89ab'cdef_u128 == clu::uint128_t(0x123456789abcdefull, 0xfedcba9876543210ull));
...
TEST_CASE("even wider literals", "[wide_integer]")
{
    ...
    REQUIRE(
        340'282'366'920'938'463'463'374'607'431'768'211'456_u256 == clu::uint256_t(0, 1)); // Greater than max uint128
    ...
    REQUIRE(0xfedc'ba98'7654'3210'0123'4567'89ab'cdef'0123'4567'89ab'cdef'fedc'ba98'7654'3210_u256 ==
        clu::uint256_t(
            clu::uint128_t(desc, asc), clu::uint128_t(asc, desc))); // Just a stupidly large number, nothing special
}
